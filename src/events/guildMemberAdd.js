...
module.exports = async (client, guildMemberAdd) => {
    ...
    const embed = new EmbedBuilder()
        ...
        .setDescription(`Welcome ${guildMemberAdd} to **Would You Support**! This server is the support server for <@981649513427111957> where you can do anything relating to Would You.\n\n**Important Channels**\n<#1018311140012478474>\n<#1009932624728440842>\n<#1009932614024568842>\n<#1023559206672007229>\n\nWe now have **${guildMemberAdd.guild.memberCount}** members!`)
        .setColor(color);
